...
const Navbar = ({ navBarSort, navBarSortByRating }) => {
    ...
    return (
        ...
        <div className="content__top">
            ...
            <svg className='burgerIcon' onClick={handleClickRatingBurger} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width='24px' height='24px'>
