...
const Navbar = ({ navBarSort, navBarSortByRating }) => {
    ...
    const [ratigBurger, setRatingBurger] = useState(false);
    ...
    const handleClickRatingBurger = () => {
        setRatingBurger(!ratigBurger)
    }
    ...
    return (
        ...
        <div className="content__top">
            <div className="burger-menu" onClick={() => handleClickFilterBurger()}>
            ...
            <div className="wrapperFilter">
                <div className={`sort ${ratigBurger ? 'active' : ''}`}>
                ...
                <svg className='burgerIcon' onClick={handleClickRatingBurger} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" width='24px' height='24px'>
